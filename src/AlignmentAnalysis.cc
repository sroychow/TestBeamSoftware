...
void AlignmentAnalysis::eventLoop()
{
   ...
   for (Long64_t jentry=0; jentry<nEntries_;jentry++) {
     ...
     //cout << "nTracks=" << telEv()->nTrackParams << endl;
     //for (int itk=0; itk<telEv()->nTrackParams; itk++) cout << "iTk="<<itk<<" xTk="<< telEv()->xPos->at(itk) <<endl;

     if (telEv()->nTrackParams==1){
       //for (int itk=0; itk<telEv()->nTrackParams; itk++) cout << "iTk="<<itk<<" xTk="<< telEv()->xPos->at(itk) <<endl;
       //cout << "d0c0="<<d0c0.size()<<" d1c0="<<d1c0.size()<<endl;
       //if (d0c0.size()==1) cout << "d0 hit="<<d0c0.at(0) << endl;
       if (d0c0.size()==1){
  ...
  int nEv1tk1hit_d1=0;
   ...
   fileAlignment << "Run "<< runNumber << " zD0= "<< d0_chi2_min_z << " offsetD0= "<<d0_Offset_aligned<< " zD1= "<<d1_chi2_min_z<<" offsetD1= "<<d1_Offset_aligned << endl;
   fileAlignment.close();
...
static double AlignmentAnalysis::FuncStepGaus(Double_t * x, Double_t * par){
