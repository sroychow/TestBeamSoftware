...
void Histogrammer::bookTelescopeAnalysisHistograms() {
  ...
  new TH1D("deltaXPos_fit", "Difference in Track impact and Hit X Position", 1000, -2.0, 2.0);
  new TH1D("deltaYPos_fit", "Difference in Track Impact and Hit Y Position", 1000, -2.0, 2.0);
  ...
  int nBins = (20e-3/20);
  new TH1D("deltaXPos", "Difference in Track impact and FeI4 Cluster X Position; x_{FeI4} - x_{Track}; Counts", (40.0)/5e-3 , -2.0, 2.0);
  new TH1D("deltaYPos", "Difference in Track Impact and FeI4 Cluster Y Position; y_{FeI4} - y_{Track}; Counts", (40.0)/5e-3 , -2.0, 2.0);
  #ifdef NOV_15
...
void Histogrammer::bookTrackFitHistograms(float zMin, float zStep, int zNsteps){
  ...
  new TH1I("d0_1tk1Hit_diffX","X_{TkAtDUT}-X_{DUT}, d0",100000,-10,10);
  new TH1I("d1_1tk1Hit_diffX","X_{TkAtDUT}-X_{DUT}, d1",100000,-10,10);

  new TH1I("d0_1tk1Hit_diffX_bis","X_{TkAtDUT}-X_{DUT}, d0",100000,-10,10);
  new TH1I("d1_1tk1Hit_diffX_bis","X_{TkAtDUT}-X_{DUT}, d1",100000,-10,10);

  new TH1I("d0_1tk1Hit_diffX_ter","X_{TkAtDUT}-X_{DUT}, d0",100000,-10,10);
  new TH1I("d1_1tk1Hit_diffX_ter","X_{TkAtDUT}-X_{DUT}, d1",100000,-10,100);

  for (int iz=0; iz<zNsteps; iz++){
    new TH1I(Form("d0_1tk1Hit_diffX_iz%i", iz),"X_{TkAtDUT}-X_{DUT}, d0",100000,-10,10);
    new TH1I(Form("d1_1tk1Hit_diffX_iz%i", iz),"X_{TkAtDUT}-X_{DUT}, d0",100000,-10,10);
  }
  ...
  new TH1I("d1_1tk1ClusterBothPlanes_diffX_aligned","X_{TkAtDUT}-X_{Cls,DUT}, d1",100000,-10,10);
