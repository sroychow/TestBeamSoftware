#ifndef EventFilter_SiStripRawToDigi_SiStripFEDDAQTrailer_H // {
#define EventFilter_SiStripRawToDigi_SiStripFEDDAQTrailer_H
...
#endif // } end def EventFilter_SiStripRawToDigi_SiStripFEDDAQHeader_H
